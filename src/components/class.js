...
const ClassRoom = () => {
  ...
  // Exemple : récupérer les ClassRoom depuis l'API Flask
  //   useEffect(() => {
            ...
            {salles.length > 0 ? (
              salles.map((sl, index) => (
                <tr key={index} className="border-t hover:bg-gray-50">
                  <td className="px-6 py-3">{sl.id}</td>
                  <td className="px-6 py-3">{sl.nom}</td>
                  <td className="px-6 py-3">{sl.type}</td>
                  <td className="px-6 py-3">{sl.capacite}</td>
                  <td className="px-6 py-3">{sl.localisation}</td>
