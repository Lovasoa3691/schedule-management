...
public record CreateEdtDto(DateOnly jour, TimeOnly hDeb, TimeOnly hFin, string dispo, string type, string responsableId, int idSalle, string enseignantId, int mentionId, int niveauId, string matiereId, int anneeId);
